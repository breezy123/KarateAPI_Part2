...
//    Builder Design Pattern
    ...
    public CustomExtentReport withKarateResults(Results testResults) {
    ...
    private ExtentTest createFeatureNode(String featureName, String featureDesc) {
        // if the title of feature is the same, will return same instance of extent test
    ...
    private ExtentTest createScenarioNode(ExtentTest featureNode, String scenarioTitle) {
        // if the scenario of feature is the same, will return same instance of extent test
        // else I will create a new instance and then return it.
    ...
    private void addScenarioStep(ExtentTest scenario, Step step, Result stepResult) {
